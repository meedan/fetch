...
describe NewtralFakes do
  describe 'instance' do
    ...
    it 'has a fact_list_path' do
      expect(described_class.new.fact_list_path(1)).to(eq("/wp-json/nwtfmg/v1/fakes?page=1&posts_per_page=15&firstDate=2018-01-01&lastDate=#{Time.now.strftime("%Y-%m-%d")}"))
    end
